...
- ClinicalDocument.effectiveTime, TS.value and Patient.birthTime are represented as a string instead of using the "TS" datatype. The TS.value element can't currently be selected in the .NET FHIRPath implementation.
